  ...
  return knex('users').del()
    .then(function () {
      ...
      return knex('users').insert([
        ...
        {user_name: 'Bryan', avatar: 'http://wickedhorror.thunderroadinc.netdna-cdn.com/wp-content/uploads/2016/08/The-Crow.jpg', password: 'asdf', projects_completed: '14', projects_collaborated:'22', projects_consulted:'27', community_rating:'586', quote: "Abashed the Devil stood and felt how awful goodness is."},
